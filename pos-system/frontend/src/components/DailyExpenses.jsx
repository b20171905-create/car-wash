...
export default function DailyExpenses({ user }) {
  ...
  const breakdownTotal = breakdownExpenses.reduce((sum, expense) => sum + Number(expense.amount || 0), 0);
